    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[(0, 'level zero'), (1, 'Level one'), (2, 'Level two'), (3, 'Level three')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[(0, 'level zero'), (1, 'Level one'), (2, 'Level two'), (3, 'Level three')], default='L0', max_length=20)),
                ...
                ('recipent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issues', to=settings.AUTH_USER_MODEL)),
            ],
            options={
